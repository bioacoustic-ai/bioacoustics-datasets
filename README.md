...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18402334.svg)](https://doi.org/10.5281/zenodo.18402334)
...
| taxonomicClass             | The taxonomix classes of the species in the dataset.                                                                                                                         | "Birds"                                                                                                                    |
| title                      | The title associated with the dataset, so that the dataset is easier to recognise.                                                                                           | "An annotated set of audio recordings of Eastern North American birds containing frequency, time, and species information" |
...
This software has an associated Zenodo DOI, that you can access through that link: https://doi.org/10.5281/zenodo.18402333

You can also directly copy-paste the following citation

```
Céline Angonin, patrik-ha, ben-williams-ai, GrunCrow, Matija Marolt, & danstowell. (2026). bioacoustic-ai/bioacoustics-datasets: v1.0.0 (v1.0.0). Zenodo. https://doi.org/10.5281/zenodo.18402334
```
